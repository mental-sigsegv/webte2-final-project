        ...
        @if(!$question_type)
            <div class="mt-4 flex justify-between items-center">
                ...
                <button type="button" wire:click="addOption"
                        class="ml-4 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
