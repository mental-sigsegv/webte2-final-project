<div class="p-6 bg-gray-800 rounded-lg">
    ...
    <form wire:submit.prevent="save">
        ...
        <div class="mb-4 flex items-center">
            <input type="checkbox" id="active" wire:change="$refresh" wire:model="active" class="w-4 h-4 text-primary-600 bg-gray-100 border-gray-300 rounded focus:ring-primary-600 dark:focus:ring-blue-500 dark:ring-offset-gray-800 dark:bg-gray-700 dark:border-gray-600">
        ...
        @if(!$active)
            <div class="mb-4">
                ...
                <input type="text" id="note" wire:model="note" class="block w-full p-2.5 bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
