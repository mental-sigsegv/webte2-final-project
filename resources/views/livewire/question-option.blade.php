<div class="mt-5">
    ...
    <div class="flex items-center mb-4">
        ...
        <label for="correct" class="text-sm font-medium text-gray-900 dark:text-white">{{ __('message.correct') }}</label>
    </div>

    <button type="button" wire:click="remove" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{{ __('message.remove') }}</button>
</div>
